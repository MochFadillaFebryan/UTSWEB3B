...
<body background="uki.jpg">
    <div class="wrap">
        <div class="logo">          
            <img src="logo uki.png">
        </div>
        <div class="header">    
		<center>
           <img src="Uki Dilayani.png">
		   </center>
            <div class="tanggal">
                <?php
                    // Tanggal hari ini
        ...
        <div class="content"><center>
            ...
            <h2>Salam sejahtera untuk kita semua</h2>
            <table>
                <tr><td>Nama</td><td>:</td><td>Mochammad Fadilla Febryan</td></tr>
                <tr><td>NIM</td><td>:</td><td>11180910000022</td></tr>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=pendaftaran">
				...
				<p> Daftarkanlah identitas mu pada laman ini </p>
            ...
            <table>
			<p> Gunakan laman ini untuk mengecek berat badan idealmu... </p>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=usia">
                <table>
				<p> Jika anda merasa bingung tentang kategori usia anda, gunakan laman ini </p>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=persegiPanjang">
                <table>
				<p> Jika anda merasa bosan, hitunglah persegi panjang ini <p/>
            ...
            <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>?show=segitiga">
                <table>
				<p> Disini ada juga luas segitiga, mari berhitung </p>
            ...
            { 
              $tinggi=$_POST['tb'];
                ...
                $usia=$_POST['yo'];
                    ...
                    {
                        echo "<p>Usia Gak Mungkin Minus lahhh.</p>";
                    }
